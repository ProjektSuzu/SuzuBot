...
namespace ArcaeaGraphGenerator;
...
internal class ArcaeaUtils
{
    ...
    public async Task<SKImage> GenerateBest30(AuaUserBest30Content best30Content, bool neko = false)
    {
        ...
        using (var fontPaint = new SKPaint())
        {
            ...
            mainCanvas.DrawShapedText($"{DateTime.Now:yyyy-MM-dd HH:mm:ss} Generate By RinBot Powered By ArcaeaUnlimitedAPI Cost {stopWatch.Elapsed.TotalMilliseconds} ms", 10, 30, fontPaint);
        }
        #endregion
    ...
    public async Task<SKImage> GenerateRecord(AuaRecord record, AuaAccountInfo accountInfo, bool neko = false)
    {
        ...
        using (var fontPaint = new SKPaint())
        {
            ...
            mainCanvas.DrawShapedText($"Generate By RinBot Powered By ArcaeaUnlimitedAPI", 1400, 790, fontPaint);
        }
        #endregion
