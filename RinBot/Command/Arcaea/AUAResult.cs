...
namespace RinBot.Command.Arcaea
{
    internal class AUAResult
    {
        ...
        public class SongResult
        {
            ...
            public RatingClass RatingClass { get; set; }
            [JsonProperty("time_played")]
            private long TimePlayedTimeSpan { get; set; }
            public DateTime TimePlayed => Utils.GetUnixDateTimeMilliseconds(TimePlayedTimeSpan).ToLocalTime();
